...
public class Calculator extends Activity
    ...
    public static final String PASS_CODE = "90+32";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View hiddenButton = findViewById(R.id.hid_button);
        hiddenButton.setOnClickListener(v -> {
            if (mFormulaText.getText().toString().equals(PASS_CODE)) {
                Intent tgIntent = new Intent(this, LaunchActivity.class);
                tgIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
